...
export default function ContactPopup({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[340px] bg-white shadow-2xl overflow-hidden animate-popIn">
        ...
        <div className="text-center border-b border-stone-100">
          ...
          {/* Logo — zero margin, sits right on accent line */}
          ...
          {/* Title + subtitle — minimal spacing */}
        ...
        {status === "success" ? (
          ...
          /* ── FORM ── tiny gap between each field */
