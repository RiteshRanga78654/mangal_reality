    ...
    >
      ...
      <section className="px-6 -mt-16 lg:-mt-24 relative z-30">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow-2xl rounded-3xl p-10 border-b-8 border-[#22C55E] transition-transform hover:-translate-y-2">
            ...
            <h2 className="text-3xl font-bold text-black leading-none tracking-tighter text-left">VMRDA Approved</h2>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          {/* Standardized Heading */}
          <h2 className="text-4xl md:text-7xl font-bold tracking-tighter leading-none">Elite <span className="text-[#22C55E]">Infrastructure</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 h-[400px] relative rounded-[3rem] overflow-hidden group shadow-2xl">
              ...
              <div className="absolute bottom-10 left-10 text-left">
                ...
                <h4 className="text-3xl font-bold text-white uppercase ">Bhogapuram International Airport</h4>
              </div>
            </div>
            ...
            <div className="h-[400px] relative rounded-[3rem] overflow-hidden group shadow-2xl">
              ...
              <div className="absolute bottom-10 left-10 text-left">
                ...
                <h4 className="text-3xl font-bold text-white uppercase leading-none">IT SEZ Corridor</h4>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center text-left">
              ...
              <div className="relative z-10">
                ...
                <div className={`transition-all duration-500 min-h-[160px] transform ${isFading ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 bg-slate-900 text-[#22C55E] rounded-full flex items-center justify-center font-bold text-xl">
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="h-64 bg-slate-100 rounded-[2rem] overflow-hidden"><img src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=400" className="w-full h-full object-cover" alt="site progress"/></div>
               <div className="h-64 bg-slate-100 rounded-[2rem] overflow-hidden mt-12"><img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=400" className="w-full h-full object-cover" alt="site project" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#0A1A10] px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="bg-white rounded-3xl overflow-hidden shadow-sm">
                <button 
