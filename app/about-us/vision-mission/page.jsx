    ...
    <main ref={containerRef} className="bg-[#0A1A10] text-[#E0E7E0] min-h-screen">
      ...
      <section className="relative h-[80vh] md:h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl  text-white mb-8"style={{fontFamily:"Arial, Helvetica, sans-serif"}}>Our Essence</h1>
          <motion.div 
            initial={{ width: 0 }}
            animate={{ width: "80px" }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          {[
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl  text-white mb-6"style={{fontFamily:"Arial, Helvetica, sans-serif"}}>{card.title}</h2>
              <p className="text-base md:text-lg leading-relaxed text-[#B0C4B0] font-light italic">
                "{card.text}"
              </p>
              <div className="absolute top-8 right-8 text-5xl  opacity-[0.05] select-none"style={{fontFamily:"Arial, Helvetica, sans-serif"}}>
                {card.accent}
              </div>
            </motion.div>
          ))}
      ...
      <section className="py-20 lg:py-32 bg-[#08140C]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-4">
            <div>
              <h2 className="text-4xl md:text-5xl  text-white mb-2"style={{fontFamily:"Arial, Helvetica, sans-serif"}}>Non-Negotiables</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            {[
              ...
              >
                ...
                <h3 className="text-lg font-bold text-white mb-4 uppercase tracking-tighter">{val.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24 text-center">
          {ecoFeatures.map((feature, i) => (
            <div key={i} className="flex flex-col items-center space-y-4">
              ...
              <h4 className="text-white text-xl"style={{fontFamily:"Arial, Helvetica, sans-serif"}}>{feature.title}</h4>
      ...
      <section className="py-40 flex items-center justify-center text-center px-6">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <p className="text-3xl md:text-5xl leading-tight text-white mb-8"style={{fontFamily:"Arial, Helvetica, sans-serif"}}>
