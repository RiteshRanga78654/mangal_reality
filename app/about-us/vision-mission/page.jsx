        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          {[
            ...
            >
              ...
              <p className="text-base md:text-lg leading-relaxed text-[#B0C4B0] font-light ">
                "{card.text}"
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-4">
            <div>
              ...
              <p className="text-[#4ADE80] tracking-[0.2em] text-[10px] md:text-xs font-bold">The Foundation of Mangal Realty</p>
            </div>
