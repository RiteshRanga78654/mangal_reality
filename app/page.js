...
// import { TreePine, Wifi, Globe, Car, Map, Wallet, ShowerHead, Users, Stethoscope, Waves, Mountain, Wind, Flame, Trash2, Gamepad2, Bath, Utensils, UserPlus, MapPin, Trees, Leaf, Home, Landmark, Palmtree, ArrowRight ,ChevronLeft, ChevronRight, Quote} from 'lucide-react';
...
// // Reusable Button Component to maintain exactly your original button style
...
//       <style jsx>{`.group:hover :global(svg) { color: white !important; }`}</style>
//     </button>
//     <button
//       onClick={next}
//       style={{ borderColor: brandGreen }}
...
//               <div key={i} className="group relative aspect-square border border-white/10 flex flex-col items-center justify-center overflow-hidden cursor-pointer m-2">
...
//               <div className="relative z-10 text-[green] group-hover:text-white transition-all duration-300 scale-175 mb-6 group-hover:scale-15 group-hover:animate-bounce">
...
//         {/* Header Section: Matches your original layout */}
//         <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-6 p-8">
//           <div className="space-y-2 text-center md:text-left">
//             <h2 className="text-3xl md:text-4xl font-bold leading-tight">
//                <span style={{ color: brandGreen }}>{'Testimonials'}</span>
//             </h2>
...
//                 >
//                   {/* Card Container: Theme Updated to Green/Light Gray */}
//                   <div className="bg-[#f3f4f6] p-8 rounded-lg shadow-xl border border-gray-100 h-full flex flex-col md:flex-row gap-6 items-start hover:shadow-[#22c55e]/10 transition-shadow duration-300 relative group">
...
//         {/* Mobile Navigation Buttons: Under the slider */}
