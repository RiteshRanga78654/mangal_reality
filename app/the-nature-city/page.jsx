...
import ContactPopup from "./PopUp";// ✅ ADD THIS IMPORT



const Page = () => {
  // ✅ ContactPopup state — same as code 2
  const [showContactPopup, setShowContactPopup] = useState(false);

  // ✅ Auto-open ContactPopup after 10 seconds — same as code 2
  useEffect(() => {
              ...
              <form className="grid grid-cols-1 md:grid-cols-4 gap-8 items-end">
                <div className="relative group/input">
                  <input
                    ...
                    placeholder="Name"
                  />
                  <label htmlFor="name" className="absolute left-0 -top-3.5 text-xs tracking-widest transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-white/30 peer-placeholder-shown:top-3 peer-focus:-top-3.5 peer-focus:text-xs" style={{ color: "#3fad26" }}>
                    Your Name
                  </label>
                </div>
                <div className="relative group/input">
                  <input
                    ...
                    placeholder="Phone"
                  />
                  <label htmlFor="phone" className="absolute left-0 -top-3.5 text-xs tracking-widest transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-white/30 peer-placeholder-shown:top-3 peer-focus:-top-3.5 peer-focus:text-xs" style={{ color: "#3fad26" }}>
                    Phone Number
                  </label>
                </div>
                <div className="relative group/input">
                  <select className="peer w-full bg-transparent border-b border-emerald-800/50 py-3 text-white focus:outline-none focus:border-emerald-400 transition-all appearance-none cursor-pointer">
                    ...
                    <option style={{ backgroundColor: "#006633" }} value="1.5">1.5Cr - 2.5Cr</option>
                    <option style={{ backgroundColor: "#006633" }} value="2.5">2.5Cr - 4Cr</option>
                  </select>
                  <label className="absolute left-0 -top-3.5 text-xs tracking-widest" style={{ color: "#3fad26" }}>Select Budget</label>
                </div>
                <div className="pt-4">
                  <button
                    style={{
                  ...
                  >
                    ...
                    <span className="btn-text" style={{ position: "relative", zIndex: 1, color: "#fff", transition: "color 0.3s ease" }}>Schedule a Visit</span>
                  </button>
                </div>
              </form>
            </div>
