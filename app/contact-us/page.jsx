...
//           popup: "rounded-[2rem]",
//           confirmButton:
//             "rounded-xl px-10 py-3 uppercase tracking-widest font-bold text-xs",
//         },
//       });
...
//       a: "Typically, initial conceptual designs are ready within 2-3 weeks depending on complexity.",
//     },
//     {
//       q: "Do you handle residential and commercial?",
//       a: "Yes, we have specialized teams for luxury housing and urban workspaces.",
//     },
//     {
//       q: "Where can I see your ongoing projects?",
//       a: "You can visit our Portfolio page or schedule a site visit through our consultants.",
//     },
//   ];
...
//                   icon: <MapPin />,
//                   title: "Location",
//                   content: "D-No: 49, Shankaramatam Road, Visakhapatnam",
//                   link: "https://maps.google.com",
//                 },
//                 {
//                   icon: <Mail />,
//                   title: "Email Us",
//                   content: "info@mangalrealty.com",
//                   link: "mailto:info@mangalrealty.com",
//                 },
//                 {
//                   icon: <Phone />,
//                   title: "Call Support",
//                   content: "+91 040-4400033",
//                   link: "tel:+910404400033",
//                 },
//               ].map((item, idx) => (
//                 <motion.a
//                   href={item.link}
...
//                       className:
//                         "text-[#0a1a10] group-hover:text-white transition-colors",
//                       size: 24,
//                     })}
//                   </div>
//                   <div>
//                     <h4 className="text-[10px] font-black uppercase tracking-widest text-[#22c55e] mb-2">
//                       {item.title}
//                     </h4>
//                     <p className="text-xl font-serif text-[#0a1a10] leading-tight">
//                       {item.content}
//                     </p>
//                   </div>
//                 </motion.a>
...
//                     <label className="text-[10px] font-bold tracking-[0.3em] text-[#22c55e] block mb-3">
//                       FULL NAME
//                     </label>
//                     <input
//                       required
...
//                 <div className="relative group">
//                   <label className="text-[10px] font-bold tracking-[0.3em] text-[#22c55e] block mb-4">
//                     MESSAGE
//                   </label>
//                   <textarea
//                     name="message"
...
//                   className="w-full md:w-auto relative group overflow-hidden bg-transparent border-2 border-[#22c55e] text-white hover:text-[white] px-12 py-6  font-black text-[10px] uppercase tracking-[0.3em] flex items-center justify-center gap-4 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
//                 >
...
//                   {/* 2. THE CONTENT LAYER */}
//                   {/* - z-10 is crucial to keep text above the green background */}
...
//         <div>
//           <span className="text-[#22c55e] font-black uppercase text-[10px] tracking-[0.5em] mb-6 block">
//             Support
//           </span>
//           <h2 className="text-5xl font-serif text-[#0a1a10] mb-12">
//             General Queries
//           </h2>
...
//           <h3 className="text-2xl font-serif text-[#0a1a10] mb-10">
//             Direct Connections
//           </h3>
...
//                 name: "Arjun Mehta",
//                 role: "Design Lead",
//                 phone: "tel:+919988776655",
//               },
//               {
//                 name: "Sara Khan",
//                 role: "Sales Head",
//                 phone: "tel:+918877665544",
//               },
//             ].map((member, i) => (
//               <a
//                 href={member.phone}
...
//                   <User
//                     size={24}
//                     className="text-[#0a1a10] group-hover:text-white"
//                   />
//                 </div>
//                 <div>
...
//                     {member.role}
//                   </p>
//                   <h4 className="text-xl font-serif text-[#0a1a10]">
//                     {member.name}
//                   </h4>
//                 </div>
